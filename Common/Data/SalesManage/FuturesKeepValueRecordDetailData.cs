...
namespace TOPSUN.ERP.Common.Data.SalesManage
{
	...
	public class FuturesKeepValueRecordDetailData :DataSet
	{
		...
		public const String MATERIALNAME_FIELD						=	"Materialname";//Begin YCX在做期货保值单时修改 2005-8-24
		public const String MODEL_FIELD								=	"Model";//Begin YCX在做期货保值单时修改 2005-8-24
		...
		private void CreateTable()
		{
			...
			columns.Add(MATERIALNAME_FIELD  , typeof(System.String));//Begin YCX在做期货保值单时修改 2005-8-24
			columns.Add(MODEL_FIELD  , typeof(System.String));//Begin YCX在做期货保值单时修改 2005-8-24
