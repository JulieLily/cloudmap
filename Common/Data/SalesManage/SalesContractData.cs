...
namespace TOPSUN.ERP.Common.Data.SalesManage
{
	...
	public class SalesContractData:DataSet
	{
		...
		public enum SalesContractRecordStatus
		{
			未确认=0,
		...
		private void BuildTable()
		{
			...
			columns.Add(CONTRACT_FIELD,typeof (System.String));//YCX做销售合同所加
			columns.Add(DEPARTMENTNAME_FIELD,typeof (System.String));//YCX做销售合同所加
