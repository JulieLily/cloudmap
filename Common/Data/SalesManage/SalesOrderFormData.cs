...
namespace TOPSUN.ERP.Common.Data.SalesManage
{
	...
	public class SalesOrderFormData:DataSet
	{
		public const string SALESORDERFORM_TABLE			="tbl_salesorderform";

		public const string ORDERFORMID_FIELD			="orderformID";
		public const string ORDERFORMNAME_FIELD			="orderformName";
		public const string ORDERFORMNO_FIELD			="orderformno";
		...
		public const string SEQUENCENAME					="orderformID";
		...
		{
			DataTable table = new DataTable (SalesOrderFormData.SALESORDERFORM_TABLE);
			DataColumnCollection columns = table.Columns;
			
			columns.Add(ORDERFORMID_FIELD,typeof (System.String));
			columns.Add(CONTRACTID_FIELD,typeof (System.String));
			columns.Add(ORDERFORMNAME_FIELD,typeof (System.String));
			columns.Add(ORDERFORMNO_FIELD,typeof (System.String));
