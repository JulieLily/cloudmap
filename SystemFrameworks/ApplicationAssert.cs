...
namespace TOPSUN.ERP.SystemFrameworks
{
	...
	public class ApplicationAssert
	{
		...
		///     </exception>
		/// </summary>
		public static void CheckCondition(bool condition, String errorName, int lineNumber)
		{
			//Test the condition
			if ( !condition )
			{
				...
				String errorText = ErrorSystem.GetErrorMessageByName(errorName);
				GenerateStackTrace(lineNumber, out detailMessage);
		...
		public static void CheckCondition(bool condition, int errorID, int lineNumber)
		{
			//Test the condition
			if ( !condition )
			{
				//Assert and throw if the condition is not met
				String detailMessage;
				String errorText = ErrorSystem.GetErrorMessageByID(errorID);
				GenerateStackTrace(lineNumber, out detailMessage);
				Debug.Fail(errorText, detailMessage);
